...
A continuación, se deberán rellenar los campos requeridos para realizar la solicitud para la instalación de puestos de comida en la Romería de San Isidro 2026. Los solicitantes deberán cumplir las siguientes condiciones:
...
3. La instalación deberá contar con un extintor de polvo ABC, en condiciones de ser utilizado según la normativa vigente.
4. Deberá disponer de un seguro de responsabilidad civil, el cual deberá ser presentado a la Hermandad de San Isidro a través del correo electrónico [hdadsanisidroalcazar@outlook.es](mailto:hdadsanisidroalcazar@outlook.es) o en formato papel **antes del 30 de abril**. Se presentará póliza y recibo de pago en vigor.
5. Certificado de instalación eléctrica diligenciado por el servicio de industria de Castilla La Mancha, el cual deberá ser presentado a la Hermandad de San Isidro a través del correo electrónico [hdadsanisidroalcazar@outlook.es](mailto:hdadsanisidroalcazar@outlook.es) o en formato papel **antes del 30 de abril**.
6. La tasa que deberá pagar a la Hermandad de San Isidro por ocupación del espacio y desarrollo de la actividad es de 150 €.
7. Deberá cumplir con todas las medidas higiénicas y normativa sanitaria aplicable a dichos puestos.
8. En todo momento deberá respetar las indicaciones realizadas por la Hermandad de San Isidro para un buen funcionamiento del evento.
